...
export const DEFAULT_BLOCK_PROPS = {
  ...
  [BLOCK_TYPES.PRODUCT_TABLE]: { columns: ['stt', 'name', 'unit', 'qty', 'price', 'total'], showHeader: true, tableTitle: '', showBorder: true, useComplexDimensions: true, enableProductImage: true, enableProductName: true, enableProductDescription: true },
  ...
  [BLOCK_TYPES.SERVICE_TABLE]: { columns: ['stt', 'name', 'symbol', 'specs', 'qty', 'unit', 'price', 'total'], showHeader: true, tableTitle: 'DỊCH VỤ & CHI PHÍ PHÁT SINH:', showBorder: true, enableProductImage: true, enableProductName: true }
};
