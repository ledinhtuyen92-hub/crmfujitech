...
- NẾU quyết định sử dụng hình ảnh để tư vấn (ví dụ khách yêu cầu xem mẫu mã, bảng giá): BẠN BẮT BUỘC PHẢI SAO CHÉP Y NGUYÊN TẤT CẢ đường link ảnh (định dạng ![...](url)) có trong context vào mảng 'image_urls'. Tuyệt đối không được tự ý bỏ bớt, cắt xén hay rút gọn bất kỳ URL nào để tránh lỗi hệ thống (như lỗi #100).
