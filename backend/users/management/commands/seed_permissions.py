...
PERMISSIONS = [
    ...
    {"code": "zalo.send_zns", "name": "Gửi tin nhắn ZNS thủ công", "module": "zalo"},
    {"code": "zalo.config", "name": "Cấu hình kết nối Zalo OA", "module": "zalo"},
    {"code": "zalo.manage_templates", "name": "Quản lý mẫu tin nhắn ZNS", "module": "zalo"},
    {"code": "zalo.campaigns", "name": "Sử dụng tính năng Chiến dịch ZNS", "module": "zalo"},
